...
printf( "RW_T2T_SUBSTATE_WAIT_READ_NDEF_FIRST_BLOCK\n" );
...
printf( "RW_T2T_SUBSTATE_WAIT_READ_NDEF_LAST_BLOCK\n" );
...
printf( "RW_T2T_SUBSTATE_WAIT_READ_TERM_TLV_BLOCK\n" );
...
printf( "RW_T2T_SUBSTATE_WAIT_READ_NDEF_NEXT_BLOCK\n" );
    ...
    case RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_NEXT_BLOCK:
      printf( "RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_NEXT_BLOCK" );
    case RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_LEN_NEXT_BLOCK:
      printf( "RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_LEN_NEXT_BLOCK\n" );
    ...
    case RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_LAST_BLOCK:
      printf( "RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_LAST_BLOCK\n" );
    ...
    case RW_T2T_SUBSTATE_WAIT_READ_NDEF_LEN_BLOCK:
      printf( "RW_T2T_SUBSTATE_WAIT_READ_NDEF_LEN_BLOCK\n" );
        /* Backup read block */
    ...
    case RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_LEN_BLOCK:
      printf( "RW_T2T_SUBSTATE_WAIT_WRITE_NDEF_LEN_BLOCK\n" );
        if (rw_t2t_add_terminator_tlv ()!=  NFC_STATUS_OK)
           failed = TRUE;
        break;

    case RW_T2T_SUBSTATE_WAIT_WRITE_TERM_TLV_CMPLT:
      printf( "RW_T2T_SUBSTATE_WAIT_WRITE_TERM_TLV_CMPLT\n" );
        done = TRUE;
        break;
